...
const extractSummaryFromResponse = (transformedMessages) => {
  ...
  const EndChat = async () => {
    ...
    console.log("Presenting Complaints: ", summaryData);
